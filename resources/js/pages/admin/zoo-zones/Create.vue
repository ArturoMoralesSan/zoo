...
const form = useForm({
    ...
    description: '',
    type: '',
    geometry: null as PolygonGeometry | null,
    is_active: true,
});

const submit = () => {
    form.post(
        admin.zooZones.store().url,
    );
};
</script>
        ...
        >
            ...
            >
                <div>
                    ...
                    >
                        Registra una nueva zona geográfica del Zoológico Sahuatoba.
                    </p>
                </div>
            ...
            >
                ...
                <div class="space-y-2">
                    <div>
                        ...
                        >
                            Delimita en el mapa el área correspondiente a esta zona.
                        </p>
                    </div>
