    ...
    <div v-if="canManageTwoFactor" class="space-y-6">
        ...
        >
            <p class="text-sm text-muted-foreground">
                ...
                solicitará un código PIN seguro al iniciar sesión. Este código
        ...
        <div v-else class="flex flex-col items-start justify-start space-y-4">
            <p class="text-sm text-muted-foreground">
                Se te solicitará un código PIN seguro y aleatorio al iniciar
                sesión, el cual puedes obtener desde una aplicación compatible
